...
function InterviewAuthRequiredModal() {
  return (
    <div className="relative min-h-[65vh]">
      ...
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="interview-auth-required-title"
        aria-describedby="interview-auth-required-description"
      ...
      >
        <h2 id="interview-auth-required-title" className="text-xl font-semibold">
          Interview practice requires login
        </h2>
        <p
          id="interview-auth-required-description"
          className="mt-2 text-sm text-slate-600 dark:text-slate-300"
        >
          Sign in to save expected interview questions and practice spoken
          answers.
        </p>
...
export function InterviewPageClient() {
  ...
  if (!user) {
    return <InterviewAuthRequiredModal />;
  }
