...
function ResumeAuthRequiredModal() {
  return (
    <div className="relative min-h-[65vh]">
      ...
      <section
        role="dialog"
        aria-modal="true"
        aria-labelledby="resume-auth-required-title"
        aria-describedby="resume-auth-required-description"
      ...
      >
        <h2 id="resume-auth-required-title" className="text-xl font-semibold">
          Resume review requires login
        </h2>
        <p
          id="resume-auth-required-description"
          className="mt-2 text-sm text-slate-600 dark:text-slate-300"
        >
          Sign in to upload your resume and review how well it matches your saved
          job postings.
        </p>
...
export function ResumePageClient() {
  ...
  if (!user) {
    return <ResumeAuthRequiredModal />;
  }
